...
const STATUS_CONFIG: Record<string, { cls: string; icon: React.ElementType }> = {
  ...
  // Some of the package handed over, the rest still owed.
  partiallydelivered: { cls: "bg-amber-100 text-amber-800 dark:bg-amber-900/30 dark:text-amber-400", icon: Package },

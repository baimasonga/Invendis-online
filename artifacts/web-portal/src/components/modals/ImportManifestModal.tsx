...
import { FileSpreadsheet, ChevronRight, ChevronLeft, AlertCircle, Truck, Car } from "lucide-react";
...
const STEP_LABELS = ["Upload", "Name Items", "Preview", "Dispatch Setup"];
  ...
  async function handleImport() {
    ...
    try {
      ...
      toast({
        ...
        description: `Manifest ${result.manifestCode} created — ${result.totalCommunities} communities, ${result.itemsCreated} new inventory item(s).`,
      });
      handleClose();
    } catch (err: any) {

...
function vehicleMarkerHtml(color: string, selected: boolean, plate: string, stale = false): string {
  ...
  return `<div style="width:36px;height:36px;background:${color};border-radius:50%;display:flex;align-items:center;justify-content:center;${ring}${faded}box-shadow:0 2px 8px rgba(0,0,0,0.35);" title="${escapeHtml(plate)}">
...
function destMarkerHtml(label: string): string {
  return `<div style="display:flex;flex-direction:column;align-items:center;" title="${escapeHtml(label)}">

          ...
          <Table>
            <TableHeader>
              <TableRow className="hover:bg-transparent border-t">
                ...
                <TableHead className="pr-4 text-right w-[140px]">
                  Actions
                </TableHead>
              </TableRow>
            </TableHeader>
                    ...
                    <TableCell className="pr-4 text-right">
                      <div className="flex items-center gap-1 justify-end">
                        ...
                        <Link href={`/campaigns/${campaign.id}`}>
                          <span className="text-xs font-medium text-green-700 hover:text-green-900 hover:underline cursor-pointer">
                            View
                          </span>
                        </Link>
                        {can.deleteCampaign &&
                    ...
                    <div className="flex flex-col items-center gap-2 text-muted-foreground">
                      ...
                      {can.createCampaign && (
                        <Button
                          ...
                          onClick={() => setCreateOpen(true)}
                        >
                          <Plus className="h-3.5 w-3.5 mr-1.5" /> Create first
                          campaign
                        </Button>
                      )}
                    </div>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              {deleteTarget?.campaignCode}) will be permanently deleted along
              with its input items. This cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
